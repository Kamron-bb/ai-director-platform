...
const DICT = {
  ru: {
    ...
    segments: "Сегменты",
    rent: "Аренда",
    rentTitle: "Аренда по терминалам",
    rentHint: "1.2% от оборота минус базовая аренда минус 6 000 сум",
    colBaseRent: "Базовая аренда",
    colRentDue: "К оплате",
    rentNegativeTitle: "Убыточные терминалы по региону",
    rentNegativeHint: "Топ-20 самых отрицательных сумм к оплате в каждом регионе",
  ...
  uz: {
    ...
    segments: "Segmentlar",
    rent: "Ijara",
    rentTitle: "Terminallar bo'yicha ijara",
    rentHint: "Aylanmaning 1.2%i minus bazaviy ijara minus 6 000 so'm",
    colBaseRent: "Bazaviy ijara",
    colRentDue: "To'lash uchun",
    rentNegativeTitle: "Hudud bo'yicha zararli terminallar",
    rentNegativeHint: "Har bir hududda to'lashga eng manfiy summalar bo'yicha top-20",
